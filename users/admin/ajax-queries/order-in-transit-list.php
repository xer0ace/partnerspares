    ...
    while($fetch = $query->fetch_array()){
      ...
      <div class='row'>
        ...
        <div class='col-xs-4 to'>
          ...
          <span class='lead marginbottom payment-info' style='background-color:#8e44ad;color:#ffffff;'>".$status."</span>
          <p>".$Dine_Method."</p>
          <p>".$Table_Number."</p>
          </div>
      ...
      <div class='col-xs-6 margintop'>
        ...
        <button type='button'  class='btn btn-success complete' id='invoice-print' name='".$fetch['Pending_Orders_ID']."'>
             <i class='fas fa-cart-arrow-down'></i> Order Received
          </button>

        <button type='button' class='btn btn-info pending' name='".$fetch['Pending_Orders_ID']."'>
            <i class='fas fa-backspace'></i> Back to Pend 
        </button>

        <button type='button' class='btn btn-danger cancel' name='".$fetch['Pending_Orders_ID']."'>
