    ...
    while($fetch = $query->fetch_array()){
      ...
      <div class='row'>
        ...
        <div class='col-xs-4 to'>
          ...
          <span class='lead marginbottom payment-info' style='background-color:#f1c40f;color:#ffffff;'>".$status."</span>
          <p>".$Dine_Method."</p>
          <p>".$Table_Number."</p>
          </div>
      ...
      <div class='col-xs-6 margintop'>
        ...
        <button type='button'  class='btn btn-success approve' id='invoice-print' name='".$fetch['Pending_Orders_ID']."'>
