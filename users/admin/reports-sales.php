              ...
              <div class="row">
                  <div class="single_widget wow fadeIn">
                      <div class="margin-login">
                          <h4 class="login-header">Reports - Sales</h4>
                            <div id="data" >
                                <label style="color:#2ecc71;"> Select a Month</label>
                                  ...
                                  <div class="dashboard">
                                      <div class="col-md-4" id="sales-header"> 
                                         <h4>Sales</h4>
                                          <h1>₱ 0000</h1> 
                                              <p>Compared to last month ₱ 0000 <i class='fas fa-minus' style='color: #1e272e; margin-top: 15px;'></i></p>
                                      </div>
                                      <div class="col-md-8">
...
<script src="scripts/reports-ajax.js"></script>
