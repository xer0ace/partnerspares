    ...
    while($fetch = $query->fetch_array()){
      ...
      <div class='row'>
        ...
        <div class='col-xs-4 to'>
          ...
          <span class='lead marginbottom payment-info' style='background-color:#2ecc71;color:#ffffff;'>".$status."</span>
          <p>".$Dine_Method."</p>
          <p>".$Table_Number."</p>
          </div>
